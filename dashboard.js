...
class CloudDashboard {
    ...
    createSkillsCharts() {
        // Cloud & Hardware Skills Chart
        this.createSkillChart('cloudSkillsChart', {
            labels: ['G-Cloud', 'Docker', 'Arduino', 'ESP32'],
            data: [90, 95, 85, 80],
        ...
        // Frameworks & AI Skills Chart
        this.createSkillChart('frameworksSkillsChart', {
            labels: ['React', 'Node.js', 'LangChain', 'LangGraph'],
            data: [95, 90, 85, 80],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });
    }
    ...
    initializeAllFeatures() {
        ...
        setTimeout(() => {
            this.addTypingEffect('.profile-title', 'Hardware & Software Engineer | B.Tech Student', 150);
        }, 2000);
    }
}
