...
╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝ ╚════╝  ╚══╝╚══╝ ╚═╝  ╚═╝╚══════╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "     Hardware & Software Engineer • B.Tech Student\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "B.Tech Computer Science student at GM University,",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Davangere. Hardware & Software Engineer.",
      "#ffffff"
    )}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor("⚡ Current Projects", "#ff8c00")}
${this.wrapWithColor(
      "   Building drones, reconfigurable continuous track robot,",
      "#ffffff"
    )}
${this.wrapWithColor("   and agentic AI platforms with LangChain & LangGraph", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
      "   Bridging hardware and software to create innovative",
      "#ffffff"
    )}
${this.wrapWithColor(
      "   real-world solutions in robotics and AI",
      "#ffffff"
    )}

${this.wrapWithColor("⚡ Philosophy", "#ff8c00")}
${this.wrapWithColor(
      "   Adaptive to evolving technologies. Always learning,",
      "#ffffff"
    )}
${this.wrapWithColor("   always building, always pushing boundaries.", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to collaborate on exciting tech projects!",
      "#ffffff"
...
${this.wrapWithColor(
  ...
  showExperience(outputElement = this.output) {
    const experience = `<span style="color: #ffff00; font-weight: bold;">💼 MY PROJECTS & JOURNEY</span>

<span style="color: #00ffff;">GM UNIVERSITY DAVANGERE | B.Tech Undergrad</span>
${this.wrapWithColor(
      "2024 - 2028 | Davangere, Karnataka, India",
      "#ffffff"
    )}
${this.wrapWithColor(
      "Focusing on Hardware & Software Engineering",
      "#98fb98"
    )}

• ${this.wrapWithColor("Robotics", "#ffa07a")} - ${this.wrapWithColor(
      "Building a reconfigurable continuous track robot",
      "#ffffff"
    )}
• ${this.wrapWithColor("Aviation", "#ffa07a")} - ${this.wrapWithColor(
      "Designing and building custom drones",
      "#ffffff"
    )}
• ${this.wrapWithColor("AI Platforms", "#ffa07a")} - ${this.wrapWithColor(
      "Developing Agentic AI systems using LangGraph & LangChain",
      "#ffffff"
    )}

<span style="color: #00ffff;">SRI VIDYA NIKETAN PU COLLEGE | Science-PCMC</span>
${this.wrapWithColor(
      "Gangavati, Karnataka, India",
      "#ffffff"
    )}

• ${this.wrapWithColor("Achievements:", "#ffa07a")} ${this.wrapWithColor(
      "Strong focus on PCMC (Physics, Chemistry, Maths, CS)",
      "#ffffff"
    )}

<span style="color: #00ffff;">RAINBOW RESIDENCIAL PUBLIC SCHOOL | ICSE</span>
${this.wrapWithColor(
      "Ranebennur, Karnataka, India",
      "#ffffff"
    )}

• ${this.wrapWithColor("Grade A", "#ffa07a")} - ${this.wrapWithColor(
      "Foundation in C and Java programming",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Adaptive to evolving technologies             ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
      "╰──────────────────────────────────────────────────╯",
...
• ${this.wrapWithColor("LangGraph / LangChain / LangSmith", "#ffffff")}
• ${this.wrapWithColor("Python (Programming Language)", "#ffffff")}
• ${this.wrapWithColor("JavaScript / HTML / CSS", "#ffffff")}
• ${this.wrapWithColor("Java", "#ffffff")}
• ${this.wrapWithColor("Google Cloud Platform", "#ffffff")}
• ${this.wrapWithColor("IoT & Embedded Systems", "#ffffff")}
• ${this.wrapWithColor("Arduino / Robotics", "#ffffff")}
• ${this.wrapWithColor("Drone Tech", "#ffffff")}
• ${this.wrapWithColor("C Programming", "#ffffff")}
• ${this.wrapWithColor("Project Management", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:prajwaljana@hotmail.com" style="color: #ffffff; text-decoration: none;">prajwaljana@hotmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/PRAJWALJAN4" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/PRAJWALJAN4</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/prajwal-jana-92715a358" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/prajwal-jana</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "prajwal@jana: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "github.com/PRAJWALJAN4";
